...
def get_resources(
    ...
    resources = resource_crud.get_resources(
        db, skip=skip, limit=limit, resource_type=resource_type
    )
...
@router.get(
    "/projects/{project_id}/resources", response_model=List[ProjectResourceAllocation]
)
...
@router.post(
    "/projects/{project_id}/resources", response_model=ProjectResourceAllocation
)
def allocate_resource_to_project(
    ...
    allocation = project_resource_crud.allocate_resource(
        db, project_id, allocation_data, current_user.id
    )
